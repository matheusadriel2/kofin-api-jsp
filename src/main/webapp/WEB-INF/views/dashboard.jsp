  ...
  <div class="container-fluid pt-4 mt-2">
    ...
    <div id="cards-summary-row" class="row gy-4 gx-1 mb-5">
      ...
      <div style="border: 1px solid #d8d8db; border-radius: 0 0.25rem 0.25rem 0; border-left: none;" class="col-12 col-xxl-7 d-flex flex-column  p-4">
        ...
        <div class="dash-summary flex-grow-1 flex-md-row gap-3">
          <div class="flex-fill bg-light border border-success border-opacity-50 p-3 align-items-start">
            <h6 class="text-success text-opacity-75">Entradas (mês)</h6>
            <h4 class="text-success">R$ ${incomeMonth}</h4>
            <small>Total: R$ ${incomeTotal}</small>
          </div>
          <div class="flex-fill bg-light border border-danger border-opacity-50 rounded p-3 align-items-start">
            <h6 class="text-danger text-opacity-75">Saídas (mês)</h6>
            <h4 class="text-danger">R$ ${expenseMonth}</h4>
            <small>Total: R$ ${expenseTotal}</small>
          </div>
          <div class="flex-fill bg-light border border-secondary border-opacity-50 rounded p-3 align-items-start">
            <h6 class="text-dark text-opacity-75">Saldo</h6>
            <h4>R$ ${saldoTotal}</h4>
    ...
    <div style="border: 1px solid #d8d8db; border-radius: 0.25rem;" class="col-12 p-4">
      ...
      <div>
        ...
        <h6 class="mb-3 me-auto text-dark text-opacity-75">Movimentos recentes</h6>
      </div>
